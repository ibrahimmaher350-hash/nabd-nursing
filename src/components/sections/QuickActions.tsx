 ...
 * 4 big touch-friendly action cards below the hero.
 */
    ...
    >
      <div className="section-container py-5 sm:py-6">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {actions.map((action) => {
            const IconComponent = 'icon' in action && action.icon ? action.icon : null
            const CustomIcon = 'iconComponent' in action ? action.iconComponent : null
            const isExternal = action.type === 'external'
            const isTel = action.type === 'tel'
