    ...
    >
      <div className="section-container section-padding text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link
            href="/booking"
            className="btn-primary w-full sm:w-auto px-8 py-4 text-base bg-gold-500 hover:bg-gold-600 shadow-gold"
            onClick={() => analytics.startBooking('final_cta', 'general')}
          >
            احجز الخدمة
          </Link>
          ...
          <a
            ...
            onClick={() => analytics.clickWhatsApp('final_cta')}
          >
