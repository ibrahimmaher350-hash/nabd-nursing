...
export default function ServiceOfferBanner({ offer }: ServiceOfferBannerProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-5 sm:p-6">
        ...
        {/* Title */}
        <h3 className="text-white font-extrabold text-base sm:text-lg leading-snug mb-1">
